...
public class MultivariateNormalEstimator implements Serializable {
	...
	/** Covariance Type: Full matrix (tidak ada batasan) */
	public static final int COVARIANCE_FULL = 0;
	/** Covariance Type: Diagonal matrix (tidak ada korelasi antara atribut data)  */
	public static final int COVARIANCE_DIAGONAL = 1;
	/** Covariance Type: Spherical matrix (semua atribut memiliki varian yang sama)    */
	...
	public void calculateDerivedParameters()  throws Exception
	{
		 m_DetVar = m_Var.det();
		  ...
		  {
			  System.err.println("Covariance matrix memiliki determinan nol");
			  return;
		  }
	...
	public 	void setVariance(Matrix m)
	{
	  ...
	  {
		  //mendapatkan vektor saple antara -1 dan 10
